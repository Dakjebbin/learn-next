...
const Reasons = () => {
  return (
    <section className="mt-10 text-white">
      <p className="text-white font-bold py-4 text-2xl">
        More Reasons to Join
      </p>

      <div className="flex flex-wrap gap-5">
        <div className="flex-grow relative basis-52 bg-gradient-to-br from-[#192247] to-[#210e17] p-5 rounded-xl">
          <h3 className="font-bold text-2xl mb-5">Enjoy on your TV</h3>
          <p className="text-[#ffffffb3] mb-20 font-semibold">
            Watch on smart TVs, Playstations, Xbox, Chromecast, AppleTV, Blu-Ray
            Players, and more.
          </p>
        ...
        <div className="flex-grow basis-52 relative bg-gradient-to-br from-[#192247] to-[#210e17] p-5 rounded-xl">
          <h3 className="font-bold text-2xl mb-5">Download your shows to watch offline</h3>

          <p className="text-[#ffffffb3] mb-20 font-semibold">Save your favorites easily and always have something to watch.</p>
          <div className="absolute bottom-0 right-5">
            <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
        ...
        <div className="flex-grow relative basis-52 bg-gradient-to-br from-[#192247] to-[#210e17] p-5 rounded-xl">
          <h3 className="font-bold text-2xl mb-5">Watch everywhere</h3>
          <p className="text-[#ffffffb3] mb-20 font-semibold">
        ...
        <div className="flex-grow  relative basis-52 bg-gradient-to-br from-[#192247] to-[#210e17] p-5 rounded-xl">
          <h3 className="font-bold text-2xl mb-5">Create profiles for kids</h3>
          <p className="text-[#ffffffb3] font-semibold mb-20">
